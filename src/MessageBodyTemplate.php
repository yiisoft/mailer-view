...
final class MessageBodyTemplate
{
     ...
     * @param string|null $htmlLayout The HTML layout view name. It is the relative to {@see $viewPath} path to file
     * with layout used to render HTML mail body, e.g., 'layouts/html'. If the value is `null`, no layout will be
     * applied.
     * @param string|null $textLayout The text layout view name. It is the relative to {@see $viewPath} path to file
     * with layout used to render text mail body, e.g., 'layouts/text'. If the value is `null`, no layout will be
     * applied.
     *
